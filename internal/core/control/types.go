...
const (
	...
	ActionPrimaryCommand              ActionKind = "surface.command.primary"
	ActionCoworkersCommand            ActionKind = "surface.command.coworkers"
	...
	ActionMCPOAuthCommand             ActionKind = "surface.command.mcp_oauth"
